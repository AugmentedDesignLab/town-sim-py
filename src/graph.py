...
if __name__ == "__main__":
	...
	parser.add_argument("-mr", "--plot", type=int, help="Radial range for plot size. Default: 3.")
	parser.add_argument("-lr", "--local", type=int, help="Radial range for local range. Default: 5.")
	parser.add_argument("-tr", "--explore", type=int, help="Radial range for explore range. Default: 10.")
	parser.add_argument("-zr", "--majorroadrange", type=int, help="Radial range for major road range. Default: 10.")
